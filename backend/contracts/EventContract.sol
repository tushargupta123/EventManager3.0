...
contract EventContract{
    ...
    function getEventDetails(uint id) public view returns(Event memory){
        return events[id];
    }

    function showMyTickets(address whose,uint id) public view returns (uint tick){
        return tickets[whose][id];
    }
}